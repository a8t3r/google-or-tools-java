...
public class PathOperator extends IntVarLocalSearchOperator {
  ...
  public PathOperator(IntVar[] next_vars, IntVar[] path_vars, int number_of_base_nodes, boolean skip_locally_optimal_paths, LongToIntFunction start_empty_path_class) {
    this(mainJNI.new_PathOperator(next_vars, path_vars, number_of_base_nodes, skip_locally_optimal_paths, start_empty_path_class), true);

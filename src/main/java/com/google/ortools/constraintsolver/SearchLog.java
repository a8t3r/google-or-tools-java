...
public class SearchLog extends SearchMonitor {
  ...
  public SearchLog(Solver s, OptimizeVar obj, IntVar var, double scaling_factor, Supplier<String> display_callback, int period) {
    this(mainJNI.new_SearchLog(Solver.getCPtr(s), s, OptimizeVar.getCPtr(obj), obj, IntVar.getCPtr(var), var, scaling_factor, display_callback, period), true);
  }

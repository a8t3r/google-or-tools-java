...
public class RoutingModel {
  ...
  public Constraint MakePathSlacks(RoutingDimension dimension, IntVar[] total_slacks) {
    long cPtr = mainJNI.RoutingModel_MakePathSlacks(swigCPtr, this, RoutingDimension.getCPtr(dimension), dimension, total_slacks);
    return (cPtr == 0) ? null : new Constraint(cPtr, false);
  }

  public SWIGTYPE_p_std__vectorT_operations_research__RoutingDimension_p_t GetDimensionsForGlobalCumulOptimizers() {
    return new SWIGTYPE_p_std__vectorT_operations_research__RoutingDimension_p_t(mainJNI.RoutingModel_GetDimensionsForGlobalCumulOptimizers(swigCPtr, this), false);
  }

  public SWIGTYPE_p_std__vectorT_operations_research__RoutingDimension_p_t GetDimensionsForLocalCumulOptimizers() {
    return new SWIGTYPE_p_std__vectorT_operations_research__RoutingDimension_p_t(mainJNI.RoutingModel_GetDimensionsForLocalCumulOptimizers(swigCPtr, this), false);
  }
  ...
  public SWIGTYPE_p_absl__flat_hash_setT_int_t GetHardTypeIncompatibilitiesOfType(int type) {
    return new SWIGTYPE_p_absl__flat_hash_setT_int_t(mainJNI.RoutingModel_GetHardTypeIncompatibilitiesOfType(swigCPtr, this, type), false);
  }
  ...
  public SWIGTYPE_p_absl__flat_hash_setT_int_t GetHardTypeIncompatibilitiesOfNode(long index) {
    return new SWIGTYPE_p_absl__flat_hash_setT_int_t(mainJNI.RoutingModel_GetHardTypeIncompatibilitiesOfNode(swigCPtr, this, index), false);
  }

  public SWIGTYPE_p_absl__flat_hash_setT_int_t GetTemporalTypeIncompatibilitiesOfNode(long index) {
    return new SWIGTYPE_p_absl__flat_hash_setT_int_t(mainJNI.RoutingModel_GetTemporalTypeIncompatibilitiesOfNode(swigCPtr, this, index), false);
  }
  ...
  public Assignment PackCumulsOfGlobalOptimizerDimensionsFromAssignment(Assignment original_assignment) {
    long cPtr = mainJNI.RoutingModel_PackCumulsOfGlobalOptimizerDimensionsFromAssignment(swigCPtr, this, Assignment.getCPtr(original_assignment), original_assignment);
    return (cPtr == 0) ? null : new Assignment(cPtr, false);
  }

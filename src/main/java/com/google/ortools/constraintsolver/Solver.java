...
public class Solver {
  ...
  byte[] buf = mainJNI.Solver_makeDefaultSearchLimitParameters(swigCPtr, this);
  if (buf == null || buf.length == 0) {
    return null;
  }
  try {
  ...
  public void updateLimits(long time, long branches, long failures, long solutions, SearchLimit limit) {
    mainJNI.Solver_updateLimits(swigCPtr, this, time, branches, failures, solutions, SearchLimit.getCPtr(limit), limit);
  }

  public static long GetTimeLimit(SearchLimit limit) {
    return mainJNI.Solver_GetTimeLimit(SearchLimit.getCPtr(limit), limit);
  }

  public static long GetBranchLimit(SearchLimit limit) {
    return mainJNI.Solver_GetBranchLimit(SearchLimit.getCPtr(limit), limit);
  }

  public static long GetFailureLimit(SearchLimit limit) {
    return mainJNI.Solver_GetFailureLimit(SearchLimit.getCPtr(limit), limit);
  }

  public static long GetSolutionLimit(SearchLimit limit) {
    return mainJNI.Solver_GetSolutionLimit(SearchLimit.getCPtr(limit), limit);
  }
  ...
  public LocalSearchPhaseParameters makeLocalSearchPhaseParameters(LocalSearchOperator ls_operator, DecisionBuilder sub_decision_builder) {
    long cPtr = mainJNI.Solver_makeLocalSearchPhaseParameters__SWIG_0(swigCPtr, this, LocalSearchOperator.getCPtr(ls_operator), ls_operator, DecisionBuilder.getCPtr(sub_decision_builder), sub_decision_builder);
  ...
  public LocalSearchPhaseParameters makeLocalSearchPhaseParameters(LocalSearchOperator ls_operator, DecisionBuilder sub_decision_builder, SearchLimit limit) {
    long cPtr = mainJNI.Solver_makeLocalSearchPhaseParameters__SWIG_1(swigCPtr, this, LocalSearchOperator.getCPtr(ls_operator), ls_operator, DecisionBuilder.getCPtr(sub_decision_builder), sub_decision_builder, SearchLimit.getCPtr(limit), limit);
    return (cPtr == 0) ? null : new LocalSearchPhaseParameters(cPtr, false);
  }
  ...
  public LocalSearchPhaseParameters makeLocalSearchPhaseParameters(LocalSearchOperator ls_operator, DecisionBuilder sub_decision_builder, SearchLimit limit, LocalSearchFilter[] filters) {
    long cPtr = mainJNI.Solver_makeLocalSearchPhaseParameters__SWIG_2(swigCPtr, this, LocalSearchOperator.getCPtr(ls_operator), ls_operator, DecisionBuilder.getCPtr(sub_decision_builder), sub_decision_builder, SearchLimit.getCPtr(limit), limit, filters);
    return (cPtr == 0) ? null : new LocalSearchPhaseParameters(cPtr, false);
  }
  ...
  public LocalSearchPhaseParameters makeLocalSearchPhaseParameters(SolutionPool pool, LocalSearchOperator ls_operator, DecisionBuilder sub_decision_builder) {
    long cPtr = mainJNI.Solver_makeLocalSearchPhaseParameters__SWIG_3(swigCPtr, this, SolutionPool.getCPtr(pool), pool, LocalSearchOperator.getCPtr(ls_operator), ls_operator, DecisionBuilder.getCPtr(sub_decision_builder), sub_decision_builder);
    return (cPtr == 0) ? null : new LocalSearchPhaseParameters(cPtr, false);
  }
  ...
  public LocalSearchPhaseParameters makeLocalSearchPhaseParameters(SolutionPool pool, LocalSearchOperator ls_operator, DecisionBuilder sub_decision_builder, SearchLimit limit) {
    long cPtr = mainJNI.Solver_makeLocalSearchPhaseParameters__SWIG_4(swigCPtr, this, SolutionPool.getCPtr(pool), pool, LocalSearchOperator.getCPtr(ls_operator), ls_operator, DecisionBuilder.getCPtr(sub_decision_builder), sub_decision_builder, SearchLimit.getCPtr(limit), limit);
    return (cPtr == 0) ? null : new LocalSearchPhaseParameters(cPtr, false);
  }
  ...
  public LocalSearchPhaseParameters makeLocalSearchPhaseParameters(SolutionPool pool, LocalSearchOperator ls_operator, DecisionBuilder sub_decision_builder, SearchLimit limit, LocalSearchFilter[] filters) {
    long cPtr = mainJNI.Solver_makeLocalSearchPhaseParameters__SWIG_5(swigCPtr, this, SolutionPool.getCPtr(pool), pool, LocalSearchOperator.getCPtr(ls_operator), ls_operator, DecisionBuilder.getCPtr(sub_decision_builder), sub_decision_builder, SearchLimit.getCPtr(limit), limit, filters);
    return (cPtr == 0) ? null : new LocalSearchPhaseParameters(cPtr, false);
  }
  ...
  public IntVarLocalSearchFilter makeSumObjectiveFilter(IntVar[] vars, LongBinaryOperator values, IntVar objective, int filter_enum) {
    long cPtr = mainJNI.Solver_makeSumObjectiveFilter__SWIG_0(swigCPtr, this, vars, values, IntVar.getCPtr(objective), objective, filter_enum);
    return (cPtr == 0) ? null : new IntVarLocalSearchFilter(cPtr, false);
  }

  public IntVarLocalSearchFilter makeSumObjectiveFilter(IntVar[] vars, LongBinaryOperator values, LongConsumer delta_objective_callback, IntVar objective, int filter_enum) {
    long cPtr = mainJNI.Solver_makeSumObjectiveFilter__SWIG_1(swigCPtr, this, vars, values, delta_objective_callback, IntVar.getCPtr(objective), objective, filter_enum);
    return (cPtr == 0) ? null : new IntVarLocalSearchFilter(cPtr, false);
  }

  public IntVarLocalSearchFilter makeSumObjectiveFilter(IntVar[] vars, IntVar[] secondary_vars, LongTernaryOperator values, IntVar objective, int filter_enum) {
    long cPtr = mainJNI.Solver_makeSumObjectiveFilter__SWIG_2(swigCPtr, this, vars, secondary_vars, values, IntVar.getCPtr(objective), objective, filter_enum);
    return (cPtr == 0) ? null : new IntVarLocalSearchFilter(cPtr, false);
  }

  public IntVarLocalSearchFilter makeSumObjectiveFilter(IntVar[] vars, IntVar[] secondary_vars, LongTernaryOperator values, LongConsumer delta_objective_callback, IntVar objective, int filter_enum) {
    long cPtr = mainJNI.Solver_makeSumObjectiveFilter__SWIG_3(swigCPtr, this, vars, secondary_vars, values, delta_objective_callback, IntVar.getCPtr(objective), objective, filter_enum);
    return (cPtr == 0) ? null : new IntVarLocalSearchFilter(cPtr, false);
  }

...
public class MPSolver {
  ...
  public String exportModelAsLpFormat(boolean obfuscated) {
    return main_research_linear_solverJNI.MPSolver_exportModelAsLpFormat(swigCPtr, this, obfuscated);
  }

  public String exportModelAsMpsFormat(boolean fixed_format, boolean obfuscated) {
    return main_research_linear_solverJNI.MPSolver_exportModelAsMpsFormat(swigCPtr, this, fixed_format, obfuscated);
  }
